...
MESSAGE = f'Unsupported file format, supported formats are {", ".join(EXTENSIONS_OPERATIONS)}' # noqa E501
...
def parse_files(file_path1, file_path2):
    ...
    if file1_extension not in EXTENSIONS_OPERATIONS or file2_extension not in EXTENSIONS_OPERATIONS: # noqa E501
